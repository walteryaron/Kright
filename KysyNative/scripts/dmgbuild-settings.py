# dmgbuild settings for the Kysy installer DMG. Builds a styled, "drag to
# Applications" window headlessly (no Finder scripting / Automation permission).
# Driven by env vars set in build-dmg.sh.
import os

application = os.environ["KYSY_APP"]            # path to Kysy.app
appname = os.path.basename(application)

format = "UDZO"
files = [application]
symlinks = {"Applications": "/Applications"}
background = os.environ["KYSY_DMG_BG"]          # 660×440 PNG
