#!/usr/bin/env swift
// Renders the Kysy app icon: a macOS-style rounded-square with a blue gradient
// and a white keyboard glyph. Writes a 1024×1024 PNG to the path given as arg 1.
//
//   swift scripts/gen-appicon.swift /tmp/kysy-icon-1024.png
import AppKit

let outPath = CommandLine.arguments.count > 1 ? CommandLine.arguments[1] : "/tmp/kysy-icon-1024.png"
let S: CGFloat = 1024
