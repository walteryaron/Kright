...
/// <summary>Always-on watcher that flips Kysy into "blind mode" while a password
/// field is focused. In blind mode the tray icon shows a slashed eye and Kysy
/// refuses to read the focused field — so it's visibly clear Kysy isn't looking
