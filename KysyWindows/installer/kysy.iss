; Inno Setup script for Kysy (Windows).
; Build with: ISCC.exe installer\kysy.iss  (or run ..\build-installer.ps1)
; Produces a per-user installer (no admin / UAC needed), like Chrome / VS Code.

#define MyAppName "Kysy"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Yaron Walter"
#define MyAppExeName "Kysy.exe"
...
OutputDir=output
OutputBaseFilename=KysySetup-{#MyAppVersion}
Compression=lzma2
