...
internal static class NativeMethods
{
    ...
    public static readonly UIntPtr KRIGHT_MARKER = (UIntPtr)0x6B726774; // "krgt"
    ...
    // ---- Process path (more reliable than MainModule.FileName cross-bitness) ----
